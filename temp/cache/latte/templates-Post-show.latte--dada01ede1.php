...
final class Templatedada01ede1 extends Latte\Runtime\Template
{
	...
	public function blockContent(array $ʟ_args): void
	{
		...
		extract($ʟ_args);
		unset($ʟ_args);
		echo '    <div class="container-xxl post-container my-4 py-4">
        <div class="row">
...
';
		/* line 7 */ $_tmp = $this->global->uiControl->getComponent("postDetailControl");
...
';
		if ($user->isAllowed('comment', 'add')) /* line 11 */ {
			/* line 12 */ $_tmp = $this->global->uiControl->getComponent("addNewCommentForm");
			if ($_tmp instanceof Nette\Application\UI\Renderable) $_tmp->redrawControl(null, false);
			$_tmp->render();
		}
		else /* line 13 */ {
			...
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Sign:")) /* line 18 */;
			echo '">
...
';
		if ($user->isAllowed('commentGrid', 'view')) /* line 31 */ {
			/* line 32 */ $_tmp = $this->global->uiControl->getComponent("commentsGrid");
			if ($_tmp instanceof Nette\Application\UI\Renderable) $_tmp->redrawControl(null, false);
			$_tmp->render();
		}
		echo '                    </div>
...
';
		if (($user->isAllowed('otherPosts', 'view'))) /* line 39 */ {
			/* line 40 */ $_tmp = $this->global->uiControl->getComponent("otherPosts");
			if ($_tmp instanceof Nette\Application\UI\Renderable) $_tmp->redrawControl(null, false);
			$_tmp->render();
		}
		echo '             </div>
