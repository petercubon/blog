...
<div class="card-body">
    ...
    <h1 class="text-uppercase text-center fw-bold mt-5">
        ';
		echo LR\Filters::escapeHtmlText($item->title) /* line 14 */;
		echo '
    </h1>
    <div class="row">
...
';
		if ($user->isAllowed($item, 'edit')) /* line 19 */ {
			echo '                <a href="';
			echo LR\Filters::escapeHtmlAttr($this->global->uiPresenter->link("Post:edit", [$item->id])) /* line 19 */;
			echo '" class="nav-link">
...
';
		if ($user->isAllowed($item, 'delete')) /* line 24 */ {
			...
			echo LR\Filters::escapeHtmlText($item->title) /* line 41 */;
			echo ' </strong>"?
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">zavriet</button>
';
			if ($user->isAllowed($item, 'delete')) /* line 45 */ {
				echo '                                <a class="btn btn-danger" href="';
				echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("delete!")) /* line 45 */;
				echo '">
                                    <i class="bi bi-trash"></i> Odstranit clanok
                                </a>
';
...
';
    ...
    <p class="small text-mutted text-center mb-5 d-inline">
        <strong> Meno Autora  ';
		echo LR\Filters::escapeHtmlText($item->id) /* line 63 */;
		echo '</strong>, ';
		echo LR\Filters::escapeHtmlText(($this->filters->date)($item->created_at, 'd.m.Y, H:i')) /* line 63 */;
		echo ' | ID clanku: ';
		echo LR\Filters::escapeHtmlText($item->id) /* line 63 */;
		echo '
    </p>
    <p class="card-text mt-3" style="text-align: justify;">
        ';
		echo LR\Filters::escapeHtmlText($item->content) /* line 66 */;
		echo '
    </p>
</div>
';
